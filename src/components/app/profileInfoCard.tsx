            ...
            <PopoverContent>
                <div className="w-full h-full flex flex-col items-center justify-center gap-2">
                    <div className='w-full relative flex flex-col items-center justify-canter gap-2'>
                        <Image alt={user?.name ?? "User profile pic"} src={user?.image ?? "https://cdn-icons-png.flaticon.com/128/847/847969.png"} height={100} width={100} className='rounded-full h-[100px] w-[100px]' />
                    ...
                    <div className='flex items-center justify-center gap-2'>
                        <EditProfileDialog />
                        <ConfirmModal label='You sure?' description='Are you sure you want to logout?' onConfirmAction={() => {
                            signOut({
                                callbackUrl: "/",
                            })
                        }}>
